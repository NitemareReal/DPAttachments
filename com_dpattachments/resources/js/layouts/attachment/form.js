...
document.querySelectorAll('.com-dpattachments-layout-form .dp-input__file').forEach((input, index) => {
...
document.querySelectorAll('.com-dpattachments-layout-form').forEach((form) => {
